...
function mfwp_options_page() {
	...
	<div class="wrap">
		...
		<input id="mfwp_settings[enable]" type="checkbox" name="mfwp_settings[enable]" value="1" <?php checked ( '1',$mfwp_options['enable'] ); ?> />
...
<select id="mfwp_settings[theme]" name="mfwp_settings[theme]"> 
	<?php foreach ( $styles as $style ) { ?> 
		<?php
		if ( $mfwp_options['theme'] == $style ) {
